        ...
        <div class="panel-body no-padding">
          ...
          <table class="table table-striped" id="myTable">
            ...
            <tbody>
              <?php
                  $i=1;
                    $select="SELECT * FROM `admission` INNER JOIN `complain` ON admission.email=complain.stu_email WHERE complain.status='pending' AND complain.com_category='Complaints' ";
                ...
                ?>
                  <tr>
                    ...
                    <td style="text-align:center;">
                      <a href="index.php?page=student_complain&email=<?php echo $row['stu_email'];?>">
