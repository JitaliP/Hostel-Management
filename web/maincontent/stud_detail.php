<!-- this page is show more detailed view of stud_list.php page....! -->
<br>
<br>
<br>
<head>
...
<body>
  <div class="container rounded bg-white " style="margin-top: 0px;">
    ...
    <div class="col-md-3 border-right">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                <div class="justify-content-between align-items-center mb-3">
                    <h4 style="text-align:center; border-bottom: 1px solid #dee2e6; padding-bottom: 10px; color:darkslateblue; text-decoration:underline;">student details</h4>
                </div>
                <div class="row mt-1" style="font-size: 18px;">
                    ...
                    <div class="col-md-6" style="color: darkslateblue;"><b>Leaving Certificate : </b><hr>
                        <!-- Trigger the Modal -->
                            <img id="myImg" src="../user penal/assets-design/frontend/llh/img/upload/<?php echo $row['leaving_cer'];?> " alt="Snow" style="width:100%;max-width:200px">
                    ...
                    <div class="col-md-6" style="color: darkslateblue;"><b>Id Proof : </b><hr> 
        ...
        <div class="col-md-4">
            <div class="p-3 py-5">
                <div class="d-flex justify-content-between align-items-center experience" style="color:darksalmon;"><span><b>CURRENT EDUCATIONAL DETAILS</b></span><!-- <span class="border px-3 p-1 add-experience"><i class="fa fa-pen"></i>&nbsp;Edit</span --></div><br>

       
                <div class="col-md-6" style="color: darkslateblue;"><b>Fees_Reciept : </b><hr>
                    <!-- Trigger the Modal -->
            ...
            <div class="p-3 py-5">
                <div class="justify-content-between align-items-center experience" style="color:darksalmon;"><span><b>PREVIOUS EDUCATIONAL DETAILS</b> </span><!-- <span class="border px-3 p-1 add-experience"><i class="fa fa-pen"></i>&nbsp;Edit</span --></div><br>

       
                <div class="col-md-6" style="color: darkslateblue;"><b>Marksheet : </b><hr> 
                    <!-- Trigger the Modal -->
...
<script src="..\web\js\imagebox.js"></script>
</body>     