...
// unset($_SESSION['admin_id']);
 ...
 //check a room bad status is active or not
 $sql_room = "select * from room_m";
 $res = mysqli_query($con,$sql_room);
while($row = mysqli_fetch_assoc($res))
{
$sql = "select * from bed_m where bed_status='deactivate' and room_id=".$row['room_id'];
$res1 = mysqli_query($con,$sql);
$row1 = mysqli_num_rows($res1);
if($row1==4)
{   
    $sql_upd = "update room_m set room_status='deactivate' where room_id=".$row1['room_id'];
...
<head>
    <title> Admin Panel  Home :: LLH</title>
...
<section id="main-content">
    ...
    if ($page!="" && file_exists('maincontent/'.$page.'.php'))
    {
        include ('maincontent/'.$page.'.php');
    }
    else
    {
        include ("maincontent/error.php");
    }
    ?>
        <!-- main ends -->
 <!-- footer -->
...
<!-- morris JavaScript -->  
<script>
   //search in table if not found then show alert
